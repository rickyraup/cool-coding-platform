...
async def test_container_creation() -> Optional[bool]:
...
async def test_container_manager() -> Optional[bool]:
...
async def test_command_execution_fallback() -> Optional[bool]:
    ...
    try:
        ...
        output, exit_code = await session_manager.execute_command(
            test_session_id, "echo 'Hello from subprocess fallback!'",
        )
