...
async def create_session(
    ...
    db_session = CodeSession(
        ...
        or "# Write your Python code here\\nprint('Hello, World!')",
...
async def get_active_terminal_sessions() -> dict[str, Any]:
...
async def get_terminal_session_info(session_id: str) -> dict[str, Any]:
...
async def cleanup_terminal_session(session_id: str) -> dict[str, Any]:
