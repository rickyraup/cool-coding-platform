...
class TestFileContentIsolation:
    ...
    def test_file_content_isolation_main_test_files(self):
        ...
        session_response = client.post("/api/postgres_sessions/", json={
        ...
        container_start = client.post(f"/api/session_workspace/{session_id}/container/start")
        ...
        main_read_response = client.get(f"/api/session_workspace/{session_id}/file/main.py")
        ...
        test_read_response = client.get(f"/api/session_workspace/{session_id}/file/test.py")
        ...
        main_read_again = client.get(f"/api/session_workspace/{session_id}/file/main.py")
    ...
    def test_multiple_file_content_isolation(self):
        ...
        for filename, expected_content in files.items():
            response = client.get(f"/api/session_workspace/{session_id}/file/{filename}")
            assert response.status_code == 200
    ...
    def test_file_update_isolation(self):
        ...
        client.post(f"/api/session_workspace/{session_id}/file/file1.py", json={"content": file1_original})
        client.post(f"/api/session_workspace/{session_id}/file/file2.py", json={"content": file2_original})
    ...
    def test_rapid_file_switching(self):
        ...
        for filename, content in files_content.items():
            client.post(f"/api/session_workspace/{session_id}/file/{filename}", json={"content": content})
    ...
    def test_concurrent_file_operations(self):
        ...
        client.post(f"/api/session_workspace/{session_id}/file/concurrent1.py", json={"content": base_content_1})
        client.post(f"/api/session_workspace/{session_id}/file/concurrent2.py", json={"content": base_content_2})
        ...
        # Update both files
        update1 = client.put(f"/api/session_workspace/{session_id}/file/concurrent1.py", json={"content": updated_content_1})
        update2 = client.put(f"/api/session_workspace/{session_id}/file/concurrent2.py", json={"content": updated_content_2})
